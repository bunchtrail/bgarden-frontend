      ...
      <div className={`${pageClasses.container} ${pageClasses.section}`}>
        ...
        <div className="mt-auto mb-4 pt-4">
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            >
              <span className="text-sm font-medium text-[#1D1D1F] group-hover:text-[#3882F6] transition-colors duration-300">
                Каталог растений
              </span>
            </Link>
            ...
            <Link
              ...
              className="flex items-center rounded-full px-5 py-2.5 border border-[#E5E5EA] shadow-sm transition-all duration-500 hover:shadow-md hover:border-[#D1D1D6] hover:bg-[#F9F9FB] group"
            >
              <span className="text-sm font-medium text-[#1D1D1F] group-hover:text-[#E97451] transition-colors duration-300">
                Карта сада
              </span>
            </Link>
            ...
            <Link
              ...
              className="flex items-center rounded-full px-5 py-2.5 border border-[#E5E5EA] shadow-sm transition-all duration-500 hover:shadow-md hover:border-[#D1D1D6] hover:bg-[#F9F9FB] group"
            >
              <span className="text-sm font-medium text-[#1D1D1F] group-hover:text-[#6366F1] transition-colors duration-300">
                Войти
              </span>
            </Link>
          </div>
