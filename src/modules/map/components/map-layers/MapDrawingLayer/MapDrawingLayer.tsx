...
// Модалки
import AreaCreationModal from './components/AreaCreationModal';
...
// Объявление для расширения LineUtil без повторного объявления _flat
declare global {
  namespace L {
    namespace LineUtil {
      function isFlat(latlngs: any): boolean;
    }
  }
}
