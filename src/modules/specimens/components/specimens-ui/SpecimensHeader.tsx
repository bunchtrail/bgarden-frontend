  ...
  return (
    <div className={`${cardClasses.outlined} rounded-xl p-6 bg-white mb-8`}>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className={`${textClasses.heading} text-3xl tracking-tight`}>
            Образцы растений
          </h1>
          <div className="mt-3">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
              <span
                className={`${textClasses.body} ${textClasses.secondary} pr-1 mb-1 sm:mb-0`}
              >
                Сектор:
              </span>
                ...
                {Object.values(SectorType)
                  ...
                  .map((sectorType) => (
                    <button
                      ...
                      onClick={() =>
                        handleSectorChange(sectorType as SectorType)
                      }
                    >
        ...
        <div className="flex space-x-3">
          ...
          <Button
            ...
            size="medium"
            onClick={toggleView}
            className={`flex items-center ${animationClasses.transition} hover:scale-105 active:scale-95 transform`}
          >
            {view === 'grid' ? (
