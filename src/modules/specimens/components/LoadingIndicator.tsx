...
export const LoadingIndicator: React.FC<LoadingIndicatorProps> = ({
  ...
  return (
    <div className={containerClass}>
      <div className={`${styles.loadingSpinner} ${getSpinnerSize()}`} />
      {message && (
  ...
  return (
    <div className='flex flex-col items-center justify-center p-6 text-center'>
      ...
      {actionLabel && onAction && (
        <button
          onClick={onAction}
          className={`${styles.buttonHover} px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors`}
        >
          {actionLabel}
        </button>
      )}
