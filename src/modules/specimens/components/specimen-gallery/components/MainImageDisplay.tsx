  ...
  if (images.length === 0) {
    return (
      <div className={mainImageStyles.placeholder}>
        <svg className="w-20 h-20 text-gray-300 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
        </svg>
        <p className="mt-2 text-gray-600 font-medium">Изображения отсутствуют</p>
        <p className="text-xs text-gray-400 mt-1 max-w-xs text-center">Добавьте изображения растения, нажав на кнопку "Добавить фото"</p>
      </div>
    );
  }
