/**
 * Централизованный модуль утилит для работы с регионами, областями и координатами
 * Решает проблему дублирования функций по обработке координат в различных модулях
 */
