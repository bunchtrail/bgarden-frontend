...
const SpecimensHeader: React.FC<SpecimensHeaderProps> = ({
  ...
  return (
    <div className="flex flex-col md:flex-row mb-8 justify-between items-start md:items-center gap-4">
      <div>
        <h1 className="text-4xl font-bold text-[#1D1D1F] tracking-tight">Образцы растений</h1>
