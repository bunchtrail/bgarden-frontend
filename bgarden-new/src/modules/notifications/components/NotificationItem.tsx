...
const NotificationItem: React.FC<NotificationItemProps> = ({ notification }) => {
  ...
  return (
    <div 
      className={`p-4 rounded-lg border shadow-md ${bgColors[type]} animate-slideIn transition-all duration-300`}
      role="alert"
    >
      <div className="flex items-start">
        ...
        {dismissible && (
          <button
            type="button"
            className="ml-auto -mx-1.5 -my-1.5 bg-transparent text-gray-500 rounded-lg inline-flex h-6 w-6 hover:bg-gray-200"
            aria-label="Закрыть"
